...
function _list() {
   ...
   request.open("GET", "http://pascal.fis.agh.edu.pl/~user/.../rest/list", true);
   request.send(null);
}
...
function _insert(form)  {
    ...
    request.open("POST", "http://pascal.fis.agh.edu.pl/~user/..../rest/save", true);
    request.send(txt);
}
...
function _delete(form) {
    ...
    request.open("DELETE", "http://pascal.fis.agh.edu.pl/~user/.../rest/delete1/"+id, true);
    request.send(null);
}
...
function _update(form) {
    ...
    request.open("PUT", "http://pascal.fis.agh.edu.pl/~user/.../rest/update1/"+id_mongo, true);
    request.send(txt);
}